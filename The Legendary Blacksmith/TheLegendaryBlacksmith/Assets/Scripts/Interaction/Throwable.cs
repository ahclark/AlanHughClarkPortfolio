...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Throwable : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            AllowTeleportWhileAttachedToHand allowTeleport = gameObject.AddComponent<AllowTeleportWhileAttachedToHand>();
            allowTeleport.teleportAllowed = true;
            allowTeleport.overrideHoverLock = false;

            SetLayer(gameObject, "Tool");
        }
        ...
        private void SetLayer(GameObject obj, string layer)
        {
            ...
            foreach (Transform childObj in obj.GetComponentInChildren<Transform>())
            {
                SetLayer(childObj.gameObject, layer);
            }
        }
    }
}
