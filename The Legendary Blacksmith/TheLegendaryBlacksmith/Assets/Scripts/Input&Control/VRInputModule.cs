...
public class VRInputModule : BaseInputModule
{
    ...
    private HashSet<UILaserPointer> _controllers;
    // controller data
    private Dictionary<UILaserPointer, ControllerData> _controllerData = new Dictionary<UILaserPointer, ControllerData>();
    ...
    public void AddController(UILaserPointer controller)
    {
        _controllerData.Add(controller, new ControllerData());
    }

    public void RemoveController(UILaserPointer controller)
    {
        _controllerData.Remove(controller);
    }

    protected void UpdateCameraPosition(UILaserPointer controller)
    {
    ...
    public override void Process()
    {
        ...
        {
            UILaserPointer controller = pair.Key;
